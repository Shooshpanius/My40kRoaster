...
export interface Unit {
  ...
  maxCount?: number;
  // Начальное количество миниатюр по умолчанию: отличается от minCount для моделей
  // в фиксированных контейнерах (min === max), где сумма индивидуальных minCount
  // меньше требуемого минимума контейнера. Например, base Navis Armsman в 9-сильном
  // контейнере Imperial Navy Breachers: minCount=5, но defaultCount=7 (9 − 1 − 1).
  defaultCount?: number;
